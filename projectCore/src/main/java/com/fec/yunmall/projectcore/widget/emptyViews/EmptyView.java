package com.fec.yunmall.projectcore.widget.emptyViews;
...
public class EmptyView extends FrameLayout {
	...
	public EmptyView(Context context, AttributeSet attrs, int defStyle) {
        ...
        init();
        TypedArray arr = context.obtainStyledAttributes(attrs, R.styleable.AttrsEmptyView);
        Boolean attrShowLoading = arr.getBoolean(R.styleable.AttrsEmptyView_Empty_show_loading, false);
        int attrImageView = arr.getInt(R.styleable.AttrsEmptyView_Empty_image_view, 0);
        String attrTitleText = arr.getString(R.styleable.AttrsEmptyView_Empty_title_text);
        String attrDetailText = arr.getString(R.styleable.AttrsEmptyView_Empty_detail_text);
        String attrBtnText = arr.getString(R.styleable.AttrsEmptyView_Empty_btn_text);
        arr.recycle();
