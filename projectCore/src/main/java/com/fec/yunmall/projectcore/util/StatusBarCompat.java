...
public class StatusBarCompat {
    ...
    public static void compat(Activity activity, int statusColor) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (contentView.findViewById(R.id.state_bar) != null) {
                contentView.findViewById(R.id.state_bar).setBackgroundColor(statusColor);
            } else {
                View statusBarView = new View(activity);
                statusBarView.setId(R.id.state_bar);
...
//            activity.getWindow().setStatusBarColor(statusBarColor);
    ...
    public static void setStatuBar(Context context) {
         View LayoutStatusBar = LayoutInflater.from(context).inflate(R.layout.view_statusbar_height, null);
        View holdSpaceView = LayoutStatusBar.findViewById(R.id.view_statusbar_height);
